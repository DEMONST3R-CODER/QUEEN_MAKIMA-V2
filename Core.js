...
updateStatus();
    ...
    //     const menulist = `
    //     Konichiwa ${pushname} 👋. I am ${global.BotName}, .A product of Thugnificent Tech™, i am here to assist in whatever you need 👨‍💻.
...
Typed *surrender* to surrender and admited defeat`
  ...
  if (smallinput.includes('hello')) {
    ...
    *Mahen, is there any help..what are you doing?*`);
  } 
  ...
  if (smallinput=='hi') {
      reply (`*So tell me honey* *What are you doing?*`)
  }
  
  
  if (smallinput=='runtime') {
    reply (`Hi💞 ${pushname}🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 🦋${runtime(process.uptime())}\n\nCurrent Time: ${kaitime}\n\nCurrent Date: ${kaidate}`)
  }
  ...
  if (smallinput=='runtime') {
      reply ('Queen makima is up and running ${runtime(process.uptime())}* 💻')
  }
  
  if (smallinput=='Hm') {
    reply ('*Hmm Hmm. Are you a dumbass... Tell me😂*.')
  }
    
  }
  
  if (smallinput=='mk') {
    reply ('*Nothing. What are you doing?*')
  }
  
  if (smallinput=='ping') {
      reply (`𝘏𝘐 ${pushname} 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 𝖘𝖕𝖊𝖊𝖉${latensie.toFixed(4)} 𝘔;𝘚
      🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 ❦︎`)
  }
  
  
  if (smallinput.includes('good morning') || smallinput.includes('Gm')) {
    reply (`* ${pushname} Good morning guys 
    I love you, be happy every day and be careful..💞 `);
  }
  
  if (smallinput.includes('good afternoon') || smallinput.includes('konnichiwa')) {
  
    reply (`Good afthernoon to you too ${pushname} 🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 🦋.`);
  
  }
  
  
  //if (smallinput.includes('good afthernoon')) {
   // reply (`Huh ${pushname} 😇.🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 🦋`);
  //   }
  
  
  if (smallinput.includes('good night')) {
    reply (`😴 Goodnight kids💞 ${pushname} have you eaten?🤷`);
  }
  ...
  */
    ...
    const responses = {
      ...
      hello: `*Hello ${pushname},* *I am ${BotName}.My current prefix is "${prefix}", How may i be of service?*`,
      kai: `Hi, my creator is currently busy, kindly follow our channel for more bot updates\n*CHANNEL:* https://whatsapp.com/channel/0029VaoOiuwDp2QH070eTE01`,
      runtime: `🦋𝘏𝘐 ${pushname}\n${nowtime}\n\n🦋𝘙𝘜𝘕𝘛𝘐𝘔𝘌:${runtime(process.uptime())}\n\n🦋𝘗𝘙𝘌𝘍𝘐𝘟: *${prefix}*\n\n🦋𝘛𝘐𝘔𝘌: ${kaitime}\n\n🦋𝘋𝘈𝘛𝘌: ${kaidate}\n\n🦋𝘛𝘰𝘥𝘢𝘺 𝘪𝘴 ${currentDay}`,
      konichiwa: `Konichiwa ${pushname}, I am ${BotName}. How can I help you?`,
      alive: '🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 🦋',
      ping: `Hi ${pushname}, 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 𝖘𝖕𝖊𝖊𝖉 =>${latensie.toFixed(4)} ms`,
    ...
    switch (command) {
      ...
      case 'sc': case 'script': case 'git': {
        ...
        let { data } = await axios.get('https://github.com/DEMONST3R-CODER/QUEEN_MAKIMA-V2');
        teks = `
┌───────────────       
│ *QUEEN MAKIMA_V2*
├───────────────
...
├───────────────
│ *GitHub* https://github.com/DEMONST3R-CODER/QUEEN_MAKIMA-V2
├───────────────
...
└────────────────`
        ...
        let buttonMessage = {
          ...
          contextInfo: {
            externalAdreply: {
              title: "POWERED BY THUGNIFICENT TECH™",
              body: " ",
              thumbnail: fs.readFileSync("Assets/pic2.jpg"),
              mediaType: 1,
              //mediaUrl: 'https://wallpapercave.com/wp/wp10524580.jpg',
              //sourceUrl: "https://wallpapercave.com/wp/wp10524580.jpg"
              mediaUrl: 'https://github.com/DEMONST3R-CODER/QUEEN_MAKIMA-V2',
              sourceUrl: "https://github.com/DEMONST3R-CODER/QUEEN_MAKIMA-V2"
            }
          }
      ...
      case 'support': case 'channel': {
        ...
        reply(`👨‍💻 *MY DEVELOPER'S CHANNEL:* https://whatsapp.com/channel/0029VaoOiuwDp2QH070eTE01`)
      }
        break;
      ...
      case 'repo': case 'botrepo': {
        ...
        A17.sendMessage(from, { react: { text: "💫", key: m.key } })
        reply(` My Source Code 👨‍💻 - https://github.com/DEMONST3R-CODER/QUEEN_MAKIMA-V2`)
      }
        break;
  ...
  *Response Speed*: ${latensie.toFixed(4)} seconds
  ...
  Type *surrender* to surrender and admit defeat...`
      ...
      case 'rob': case 'attack':
...

        {
          ...
          if (k > balance2.wallet) return reply(`*Sorry, your victim is too poor 😭*.`);
          let tpy = random
          switch (random) {
            case 'ran':
      ...
      */
      ...
      case 'getcase':
        if (isBan) return reply(mess.banned);
        if (m.sender != '2347079059033@s.whatsapp.net') { return; }
  ...
  👉 Following : ${gitdata.following}`
      ...
      case 'git-clone':
        ...
        if (!args[0]) {
          return reply(`Please provide the GitHub repository link.\nExample:\n${prefix}${command} https://github.com/DEMONST3R-CODER/QUEEN_MAKIMA-V2
🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆  🦋
          `);
        }
      ...
      case 'listgc': {
        ...
        let teks = ` 「  🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 🦋 group user list  」\n\nTotal ${anu.length} users are using bot in Groups.`
        for (let i of anu) {
...
*Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
      ...
      case 'hidetag': case 'tag': case 'ooo': {
        ...
        if (!isAdmins && !isCreator) return reply(mess.useradmin)
        A17.sendMessage(from, { react: { text: "💬", key: m.key } })
        A17.sendMessage(m.chat, { text: args.join("🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 🦋") ? args.join("🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 🦋") : '', mentions: participants.map(a => a.id) }, { quoted: m })
      }
        break;
      ...
      case 'tagadmins': case 'admins': {
        ...
        if (!m.isGroup) return reply(mess.grouponly);
        A17.sendMessage(from, { react: { text: "🗿", key: m.key } })
        if (!text) return reply(`*🦋 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 🦋*`)
        let teks = `*「 Tag Admins 」*
...
*Message : ${text}*\n\n`
      ...
      */
      ...
      case "tts": case "texttospeech": {
        ...
        if (!args[0]) return reply("Please give me a text")
...
_Click the button below to download_`
      ...
      case 'yts': case 'ytsearch': {
        ...
        if (!args.join(" ")) return reply(`Example : -yts queen makima md 2023`)
...
└─────────────`,
      ...
      case 'spotify': {
        ...
        if (!q) return reply(`Please provide a query. Example: ${prefix + command} Ocean eyes by Billie eilish`);

        let abuffer = `https://api.kyuurzy.site/api/download/aio?query=${encodeURIComponent(q)}`
        let bbuffer = await fetchJson(`https://api.kyuurzy.site/api/download/aio?query=${encodeURIComponent(q)}`)
      ...
      case 'ytvd': case 'video': case 'ytvideo': case 'ytmp4': {
        ...
        A17.sendMessage(from, { video: { url: ytmp4play.videoUrl }, mimetype: "video/mp4", caption: anu.title + '*QUEEN MAKIMA*\n*ʏᴛ-ᴠɪᴅᴇᴏ*', }, { quoted: m })
      }
      ...
      */
      ...
      case 'ytmp3': {
        ...
        await A17.sendMessage(from, { document: fs.readFileSync(ytmp3play2.path), fileName: 'QUEEN MAKIMA_V2_Downloader.mp3', mimetype: 'audio/mpeg', }, { quoted: m })
      }
        break;
      ...
      case 'ytvd2': case 'ytmp4': {
        ...
        A17.sendMessage(from, { video: { url: ytmp4play2.videoUrl }, mimetype: "video/mp4", caption: '━━━❬❬🦋 *QUEEN MAKIMA_V2* 🦋❭❭ ━━━*', }, { quoted: m })
      }
        break;
...
await A17.sendMessage(m?.chat, {react: {text: `🎼`,key: m?.key,}}) 
reply('`Searching...`') 
let d = await fetchJson(`https://api.popcat.xyz/lyrics?song=${args[0]}`)
A17.sendMessage(m.chat, { text: d.lyrics})
}
break
      ...
      case 'swm': case 'take': case 'stickerwm': case 'steal': {
        ...
        if (!args.join(" ")) return reply(`error`)
        const swn = args.join(" ")
      ...
      case 'handsomecheck':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "😺", key: m.key } })
        if (!text) return reply(`Tag Someone, Example : ${prefix + command} @mark`)
      ...
      case 'dare':
        ...
        buffer = await getBuffer(`https://i.imgur.com/AbtXxzk.jpeg`)
...
{buttonId: `${prefix}waifu3`, buttonText: {displayText: `>>`}, type: 1},
  ...
  ❄ *Description:* ${anime.synopsis}*`
    ...
    case 'help': case 'makima': case 'menu': case 'allmenu': case 'list':{
      if (isBan) return reply(mess.banned);	 			
      if (isBanChat) return reply(mess.bangc);
  A17.sendMessage(from, { react: { text: "👸" , key: m.key }})      
  const helpmenu = ` 
...
✿︎| ▸  *Tɪᴍᴇ : ${kaitime}* ⌚
❦︎| ▸  *Dᴀᴛᴇ : ${kaidate}* 📆
✿︎| ▸  *Oᴡɴᴇʀ : ${global.OwnerName}* 👨‍💼
❦︎| ▸  *Pʀᴇꜰɪx : 『  ${prefix} 』*  💡
✿︎| ▸  *Rᴜɴᴛɪᴍᴇ : ${runtime(process.uptime())}* 💻
❦︎|  *DEVELOPED BY THUGNIFICENT* 
┬│  *A PRODUCT OF THUGNIFICENT TECH™*
│╰───────────···❦︎
└──────────────···▸▸▸
┌──『•• 👑 *ᴀʟʟᴍᴇɴᴜ* 👑 ••』──❦︎
│╭────────────···❦︎
┴│
✿︎| ▸ *${prefix}1.1*  *ʙᴏᴛᴍᴇɴᴜ*
❦︎| ▸ *${prefix}1.2*  *ᴏᴡɴᴇʀᴍᴇɴᴜ*
✿︎| ▸ *${prefix}1.3*  *ɢʀᴏᴜᴘᴍᴇɴᴜ*
❦︎| ▸ *${prefix}1.4*  *ᴀɴᴛɪʟɪɴᴋ on/off*
✿︎| ▸ *${prefix}1.5*  *ᴇᴄᴏɴᴏᴍʏ*
❦︎| ▸ *${prefix}1.6*  *ᴄᴏɴᴠᴇʀᴛ*
✿︎| ▸ *${prefix}1.7*  *ᴅᴏᴡɴʟᴏᴀᴅᴇʀ*
❦︎| ▸ *${prefix}1.8*  *ɢᴀᴍᴇᴍᴇɴᴜ*
✿︎| ▸ *${prefix}1.9*  *ʀᴇᴀᴄᴛɪᴏɴs*
❦︎| ▸ *${prefix}2.0*  *nsfwmenu*
┬│
│╰───────────···❦︎
└──────────────··❦︎`
        let buttonMessage = {
          video: fs.readFileSync('./system/Makima1.mp4'), gifPlayback: true,
          caption: helpmenu,
...
✿︎| ▸ ${prefix}ꜱᴛᴀʟᴋ
❦︎| ▸ ${prefix}ꜱᴇᴛᴘʀᴇꜰɪx
✿︎| ▸ ${prefix}ᴀᴜᴛᴏ-ᴛʏᴘɪɴɢ  
❦︎| ▸ ${prefix}ᴀᴜᴛᴏ-ꜱᴛᴀᴛᴜꜱ
✿︎| ▸ ${prefix}ᴀᴜᴛᴏ-ʀᴇᴄᴏʀᴅɪɴɢ 
┬│
│╰───────────···❦︎
└──────────────···❦︎`)
        }
...
✿︎| ▸ ${prefix}ᴘʀᴏᴍᴏᴛᴇ  
❦︎| ▸ ${prefix}ᴅᴇᴍᴏᴛᴇ  
✿︎| ▸ ${prefix}ɢʀᴏᴜᴘ-ᴇᴠᴇɴᴛ  
❦︎| ▸ ${prefix}ɢʀᴏᴜᴘꜱᴇᴛᴛɪɴɢ
❦︎| ▸︎${prefix}ɢʀᴏᴜᴘʟɪɴᴋ
✿︎| ▸ ${prefix}ɪɴᴠɪᴛᴇ
❦︎| ▸ ${prefix}ᴀᴅᴅ
✿︎| ▸ ${prefix}ʀᴇᴍᴏᴠᴇ 
❦︎| ▸ ${prefix}ꜱᴇᴛɴᴀᴍᴇ
...
❦︎| ▸  ${prefix}ᴡᴀʟʟᴇᴛ 
✿︎| ▸  ${prefix}ʙᴀɴᴋ
❦︎| ▸︎  ${prefix}ʙᴀɴᴋᴜᴘɢʀᴀᴅᴇ 
✿︎| ▸  ${prefix}ᴅᴇᴘᴏꜱɪᴛ
❦︎| ▸  ${prefix}ᴡɪᴛʜᴅʀᴀᴡ
✿︎| ▸  ${prefix}ʀᴏʙ / ᴀᴛᴛᴀᴄᴋ 
❦︎| ▸  ${prefix}ᴛʀᴀɴꜱꜰᴇʀ / ɢɪᴠᴇ 
✿︎| ▸  ${prefix}ᴡᴇᴀʟᴛʜ / ʀɪᴛᴜᴀʟ 
┬│
│╰───────────···❦︎
└───────────────···❦︎`)
        }
...
│╭────────────···❦︎
┴│
❦︎| ▸ ${prefix}ᴛᴛᴛ / ᴛɪᴄᴛᴀᴄᴛᴏᴇ   
✿︎| ▸ ${prefix}ᴛʀᴜᴛʜ
❦︎| ▸ ${prefix}ᴅᴀʀᴇ
✿︎| ▸ ${prefix}ꜱᴘɪɴ / ꜱʟᴏᴛ  
❦︎| ▸ ${prefix}ɢᴀᴍʙʟᴇ / ʟᴏᴛᴛᴇʀʏ  
┬│
│╰───────────···❦︎`)
        }
...
└──────────────···❦︎`)
        ...
        if (isCmd) {
          ...
          reply(`*Hi ${pushname}*, 𝕼𝖚𝖊𝖊𝖓 𝖒𝖆𝖐𝖎𝖒𝖆 𝖘𝖕𝖊𝖊𝖉 => *${latensie.toFixed(4)}* 𝖒𝖘`)
        }
...
{buttonId: `${prefix}qr`, buttonText: {displayText: `Tap to Re-run Repl`}, type: 1}
      ...
      default:
        ...
        if (isCmd) {
          ...
          if (isBanChat) return reply(mess.bangc);
          A17.sendMessage(from, { react: { text: "❌", key: m.key } })
          reply(`Hey *${pushname}* *Unfortunately,i wasn't programmed to have that feature.*${prefix}*Type .menu to see all my other features*`)
